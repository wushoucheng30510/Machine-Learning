...
import matplotlib.pyplot as ansis    
import math
...
#price_format = price_prediction['price']
...
original_feature= [  
                   ...
                   ori_condition,
                   ori_grade,
                   ori_sqft_above,                                         #orignal features in csv file  (15)
                   ori_sqft_basement,
                   ori_yr_built,
                   ori_yr_renovated,
                   ori_zipcode,
...
learning_rates_matrix = [0.1,0.01,0.001,0.0001]
...
count2=0 
count_zipcode2_matrix= []
output_matrix = []
for i in range (98001,98200):
    for k in range (0,5597):
        if ori_zipcode2[k] == i:                                             #calculate the percentage of each zipcode
            count2= count2 +1
        else:
            count2 = count2
        if k == 9999:
            count_zipcode2_matrix.append(count2)
            count2 =0
print ("Zipcode:",count_zipcode2_matrix)       
